...
Detector Configuration:
    ...
    Subarray(s): FULL
    Filter(s): SHORT grating setting, SHORT detector only
    Readout(s): SLOW
...
Other Notes: Simulated data and pipeline outputs for MRS Notebook 1 (https://github.com/STScI-MIRI/MRS-ExampleNB/tree/main/Notebook1), a version of which will be part of JWebbinar #4 (spectroscopic mode overview).
