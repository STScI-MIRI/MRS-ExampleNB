...
Pipeline Used: v1.4.3
Data Location: https://stsci.box.com/shared/static/z1wm5mmlzhfrnxx9ihlw6fiw3rgty37h.zip

Target Description: Mock extended source with a realistic science spectrum, 4-pt EXTENDED SOURCE dither, with dedicated background observations
Detector Configuration:
Subarray(s): FULL
Filter(s): SHORT (1A,2A,3A,4A)
Readout(s): SLOW
Groups/Ints/Exposures: 20/1/4
Dithers: Extended-source 4-point dither
...
Other Notes: Simulated data and pipeline outputs for MRS Notebook 3 (https://github.com/STScI-MIRI/MRS-ExampleNB/tree/main/Notebook3).
